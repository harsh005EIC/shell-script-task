# File : 170877_harsh_shellscript_q13_function.sh
# Author : harsh kerai
# Date : 22 jan 2026
# Description : Create a script that tracks and logs user logins and logout events, appending the data to a log
